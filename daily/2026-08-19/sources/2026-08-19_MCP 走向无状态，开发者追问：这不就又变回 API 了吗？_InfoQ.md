...
> 原文链接：https://mp.weixin.qq.com/s/FLIWjokqgTKi-qaIsjTE-w
> 来源：InfoQ
...
迄今为止，智能体治理一直从另一个方向发展。Cloudflare 的 智能体追踪 和 Azure API Management 的 AI Gateway 层 都位于协议之上，作为独立的控制层存在。此次发布将元数据放入传输层，使基础设施团队已经在运行的系统能够读取它。
