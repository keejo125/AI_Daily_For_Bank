...
digest: |
  中科紫东太初旗下ScienceClaw升级AutoProject项目级自主科研引擎，推动AI4S从「做Task」走向「做Project」。系统由三层构成：Project2Task项目级规划、TaskExecutor长程自主执行、EviGraph证据驱动验证。
  EviGraph在ARCBenchML综合得分0.865（基线0.596），Claim Support Rate较基线提升40.74%。支持人提出目标、AI自主完成「规划→拆解→执行→验证→修复→沉淀」全链路，覆盖生命、材料、化学等领域，实现工具级到系统级的跨越。
---

# AI4S开始进入「项目时代」：紫东太初把AI从做Task推向做Project

> 原文链接：https://www.qbitai.com/2026/08/479096.html
> 来源：量子位
...
完成了一次关键升级。
此次推出的
AutoProject项目级自主科研引擎
，旨在解决“如何把一个科研项目做得更好”，推动AI从执行孤立任务，走向承接完整的科学发现。
...
紫东太初AutoProject自研EviGraph证据图谱体系，搭建
全链路、跨子任务，可核验、可回溯、可修复的可信科研闭环
。
...
但大模型只是起点。
紫东太初进一步把模型能力延伸到真实科研流程，构建了从
模型底座、科研知识、专业工具到智能体执行
的完整技术体系。
...
表象上，这只是AI的工作单元从Task升级为Project；但其本质，是AI科研能力由
工具级
向
系统级
的跨越。
