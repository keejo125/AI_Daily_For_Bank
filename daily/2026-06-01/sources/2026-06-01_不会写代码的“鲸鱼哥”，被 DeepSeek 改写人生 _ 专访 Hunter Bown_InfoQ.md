---
publish_time: 1780281199
---

# 不会写代码的“鲸鱼哥”，被 DeepSeek 改写人生 | 专访 Hunter Bown

> 原文链接：https://mp.weixin.qq.com/s/TrE6RcmteXIExorFBH4PBw
> 公众号：InfoQ
...
我是 Hunter Bown，大家也叫我“鲸鱼哥”或者 “Whale Bro”，后面可能还会有别的叫法。
...
那是五月初，我刚刚考完版权法的期末考试。那场考试是晚上六点到十点，这是我见过最糟糕的考试时间安排。考完之后，我感觉自己考得很差，回到家之后就继续埋头做项目。
...
说实话，是一种 overwhelming 的感觉，有点被淹没了。
...
这是个很长的故事，我尽量讲清楚，因为这真的是我的人生，而且它每天都在变化。
...
因为它们已经有自己的商业产品了。所以对我来说，关键是找到机会在哪里，市场空白在哪里。
...
我觉得要看情况。开源本身并不天然关于利润，它更关乎分发，以及 IP 策略，或者说一种部分产权策略。
...
我觉得大家需要理解的是，今年一月我还坐在电脑前想：Peter 到底是怎么做到的？
...
说实话，从一月到四月，我其实在申请不少 AI 公司，也参加了一些面试。
...
我觉得，对于一个开源模型来说，100 万 token 的上下文窗口是非常大的事情。它允许不同的工作流出现。
...
没有。除了当年 MySpace Top 8 那种 HTML 页面。
...
我选择 Rust，是因为它非常适合 LLM 的能力，因为它有很强的自我验证特性。它能让模型以一种在其他语言里不太容易实现的方式运作。
...
我会把 Agent 理解成有某种“惯用倾向”的东西。也就是说，这个角色、这种智能，它独特的地方是什么？
...
我最近在看一部美剧叫《Severance》，不知道它在中国火不火，但在美国很火。
...
我会说，主要区别在于实际界面。DeepSeek-TUI 是有意做成 TUI，而不是 CLI。我很受 OpenCode 启发，尤其是他们利用屏幕空间的方式。如果我把窗口放大，右侧就会出现一些内容，诸如此类。
...
Hard-working，努力。可能还有 communal，就是很有社区感。
...
我自己也非常努力工作。但我倒希望我的工作只是 performative，像是在表演努力。我希望它只是那种，“哦，我最好去工作一下。”
...
我确实注意到一些小差异，但这些差异似乎更多是阶段性的。比如我会听到有人说，“我真的很喜欢 Opus 4.7。”然后他们又会说，“我不喜欢那个，我喜欢 5.5。”
...
我现在已经不觉得它还是一个 one-person company 了。因为当它被更多人看到之后，大家真的帮了我非常多。
...
这需要大量沟通。我真的就是回复很多人。现在我没办法像自己希望的那样回复那么多人了，但一开始确实是这样。
...
我认为，现在是 attention drives skill，注意力驱动技能。
...
我觉得耐心非常重要。我现在从一个项目想法走到第一个 prompt 的过程，变得越来越长。通常一开始，我会给手边能用的 AI 发一段语音。
...
我觉得第一件事，就是随便 prompt 点什么。你必须真的开始做，才能学会怎样做对。
...
我觉得答案应该同时建立在基础知识和当前研究之上。我并不认为所有 LLM 研究都是沿着一条直线不断前进的。我觉得最近有一段时间，一些研究有点疯狂，开始偏离更基础的问题。
...
太棒了。这感觉像是中了彩票。真的就是这样。这是世界上最特别的事情。
...
目前还没有。但我确实有很多想法。让我感到惊喜的是，社区其实已经在帮我想了。
