...
digest: |
  Google DeepMind发布WeatherNext 3，旗舰气象AI模型首次引入实时卫星数据、小时级刷新、更高分辨率与精准降水预报，并加入清洁能源变量。其分辨率为前代5倍，已集成进Search、Gemini、Maps与Cloud。模型以实时卫星数据替代传统物理模拟，面向农业、可再生能源与日常规划提供更高精度预报。
---

# 谷歌DeepMind发布WeatherNext 3：迄今最精准的全球气象AI模型
...
Explore
Weather Lab
to see WeatherNext 3 visualized in real-time
See where WeatherNext 3 ranks on independent
live leaderboards
from Brightband.
