---
publish_time: 1785870000
status: confirmed
category: 其他
is_model_related: false
digest: |
  OpenAI 发布博客阐述其第三方网络安全评估框架：邀请独立机构对 OpenAI 模型进行网络安全能力测试，以评估模型在漏洞发现、攻击利用和防御等方面的潜在风险。该框架是 OpenAI 模型安全治理体系的一部分，旨在通过外部独立验证增强模型发布前的安全评估可信度。
---
