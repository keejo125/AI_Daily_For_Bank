...
digest: |
  Google DeepMind发布Gemini Omni 1.1 Flash，面向开发者的生产级视频生成更新。新版本提供场景延展（最长40秒）、首末帧插值设定、4K高清放大与更快原型能力，并可通过Google AI Studio与Gemini企业智能体平台调用，让创作者在镜头运动与转场过渡上获得更精细的控制。
---

# Gemini Omni 1.1 Flash 发布：为生成式视频提供更强的控制力
...
Gemini Omni
brought real-world reasoning to generative creation, and today’s updates make Omni 1.1 production-ready for professional use via the Gemini API in Google AI Studio.
...
Try out Omni 1.1 directly in
Google AI Studio
.
Build on Gemini Enterprise Agent Platform
: Enterprises can build with Omni 1.1 directly via
Agent Platform API
.
...
and
prompting guides
to learn how to integrate scene extensions, video references, and upscaling into your applications.
Omni 1.1 is also available to all Google AI Plus, Pro and Ultra subscribers globally in
Google Flow
, starting today. Scene extension is available to all Google AI Plus, Pro and Ultra subscribers globally in the
Gemini app
.
