---
publish_time: 1777427100
---

# AI 写代码太烧钱了：Copilot、Claude 一起涨价，不如把程序员请回来？

> 原文链接：https://mp.weixin.qq.com/s/yT-T8wzmdtIkuu0ylpa3XQ
> 公众号：InfoQ
...
这种压力，其实已经开始体现在更早的动作里。GitHub

上周已经释放出一个信号

：为了止住持续扩大的亏损，公司暂停了 Copilot、Pro、Pro+ 以及 Student 套餐的新用户注册。
...
Anthropic 也一样。 本月初，数百万 OpenClaw 用户发现这款爆火的 AI 代理工具

被 Anthropic 严重限制了

。现在 Claude Code 也一并改了规则：每月 20 美元的 Pro 用户想继续用 Opus 模型？得额外付费。负责人 Boris Cherny 也曾直言：“订阅模式本就不是为这种使用强度设计的。”翻译成人话：OpenClaw 这些工具 7×24 小时跑 Agent，我们扛不住了。
