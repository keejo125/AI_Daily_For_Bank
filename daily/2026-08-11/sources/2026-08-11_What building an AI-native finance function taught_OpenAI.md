...
digest: |
  OpenAI CFO分享了两年来构建AI原生财务团队的五个实战经验。团队设定两大目标：零日关账和持续自动化预测。前者让管理者获得实时、可追溯的公司财务状况视图；后者在此基础之上展示业务变化趋势和可选决策路径。

  五大经验包括：给所有人开放AI使用权限并围绕真实问题组织结构化实验；围绕关键决策重新设计工作流而非简单叠加AI工具；赋予财务人员自行构建所需工具的能力；在每项工作流中嵌入清晰的问责机制；衡量AI完成的可靠工作量以提供明确ROI。文章指出，AI让财务变成实时职能，真正价值不在于更快关账或刷新预测，而在于让团队看到业务正在发生的变化、帮助领导者更早行动、并为决策留出更多时间窗口。
---
...
I also saw a familiar starting point. Closing the books and updating forecasts still involved manual, recurring work: finding information, explaining what changed, and assembling the inputs for a decision.
...
Recent
OpenAI research
shows that 40% of finance professionals’ specialized AI use involves work outside traditional finance, and 22% involves engineering-related tasks.
...
My finance team shared what this looks like in practice, you can
watch that recording here
⁠
